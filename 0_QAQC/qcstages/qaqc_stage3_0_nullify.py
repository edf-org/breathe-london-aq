...
,if(qc_flag in (4,5,6,7,9,91,92,93,94,10), null
  ,if(parameter_id = 3 and vid = 27522, value*1.1
  ,if(parameter_id = 3 and vid = 27533, value*1.12
  ,if(parameter_id = 140 and vid = 27522, value*0.83
  ,if(parameter_id = 140 and vid = 27533, value*0.71, value)))))
  as value
